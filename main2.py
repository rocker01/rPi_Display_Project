...
draw.text((0, 0), 'Hello! I\'m ' + hostName, font=font18, fill=0)
draw.text((0, 35), hostName + '   ' + ipAddress2, font=font18, fill=0)
draw.text((0, 70), time.strftime("%H:%M:%S %Y-%m-%d"), font=font18, fill=0)
